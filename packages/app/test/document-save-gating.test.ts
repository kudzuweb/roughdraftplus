...
describe("document save gating", () => {
  it.each([
    ...
    [
      { documentDiskChangeState: "clean", reviewHandoffState: "notifying" },
      false,
    ],
    [
      { documentDiskChangeState: "clean", reviewHandoffState: "undelivered" },
      false,
    ],
    ...
    [
      { documentDiskChangeState: "server-gone", reviewHandoffState: "idle" },
      true,
    ],
